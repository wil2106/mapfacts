...
const i18n = new I18n({
  en: {
    fact_not_found: "The fact was not found. Please contact support if you think this is an error.",
  ...
  fr: {
    fact_not_found: "Le post est introuvable. Merci de contacter le support si tu penses que c'est une erreur.",
